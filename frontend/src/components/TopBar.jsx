...
const Topbar = () => {
  return (
    <div className="font-primary  bg-[#ea2e0e] text-white">
      <div className="container mx-auto px-4 py-2 sm:py-3">
        <div className="flex items-center justify-between">
          ...
          <div className="flex-grow text-center text-base cursor-pointer hover:text-gray-300 transition-all delay-150">
